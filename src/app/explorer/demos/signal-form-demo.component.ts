...
// Signal Form: the model and field state are signals read into the template.
// TextFields are bound to the field value signals manually since the DOM Field
// directive isn't available in NativeScript.
@Component({
