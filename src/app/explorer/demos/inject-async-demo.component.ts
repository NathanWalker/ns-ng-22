...
// injectAsync() resolves a dependency behind a dynamic import. The LazyGreeter
// chunk loads only when you tap the button.
@Component({
...
export class InjectAsyncDemoComponent {
  // injectAsync must run in an injection context; a field initializer works.
