...
// Highlights from the Angular 22 release.
export const FEATURES: NgFeature[] = [
  {
    ...
    why: 'Faster apps with zero ceremony where the performance-first path is now the default path. A migration adds `ChangeDetectionStrategy.Eager` only where legacy components truly need it.',
    demo: 'counter',
    code: `@Component({
